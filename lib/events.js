...
(function() {
  ...
  $(function() {
    var dragObj, findObj, getPixelPosOfObject, getPixelPosOfObjectWithinGroup, hoverFun, isDrag, isSelected, mouseDownFun, mouseMoveFun, mouseUpFun, path, rect, rect2, rect3, rect4, rect5,
      _this = this;
    ...
    rect4.set('left', -300);
    rect4.set('top', -300);
    this.masterGroup.add(rect).add(rect2).add(rect3).add(rect4).add(rect5);
