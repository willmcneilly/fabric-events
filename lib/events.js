...
(function() {
  ...
  $(function() {
    ...
    mouseDownFun = function(e) {
      ...
      _this.selectedObj = findObj(e.e.x, e.e.y);
    ...
    mouseMoveFun = function(e) {
      ...
      if (_this.isMouseDown && _this.currentlySelected) {
        ...
        console.log(top);
        _this.currentlySelected.obj.set('left', e.e.x - 300.);
        _this.currentlySelected.obj.set('top', e.e.y - 300.);
        _this.canvas.renderAll();
    ...
    newPath.scale(0.30);
    this.masterGroup.set('width', 600);
    this.masterGroup.set('height', 600);
